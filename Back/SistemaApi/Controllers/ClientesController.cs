...
namespace SistemaApi.Controllers
{
    ...
    public class ClientesController: ControllerBase
    {
        ...
        {
            var clientes = await context.Clientes.Include(x => x.Ventas).ThenInclude(y => y.VentaLines).ThenInclude(z => z.Productos).ToListAsync();
        ...
        {
            var cliente = await context.Clientes.Include(x=>x.Ventas).ThenInclude(y=>y.VentaLines).ThenInclude(z=>z.Productos).FirstOrDefaultAsync(x => x.Id_cliente== id);
