      ...
      {(formikProps) => (
        <Form>
          <div className="container w-75 bgColor mt-5 rounded shadow">
            <div className="row">
              ...
              <div className="col p-5 rounded-end">
                ...
                <h2 className="fw-bold text-center py-5">{props.tipo}</h2>
                <div className="mb-4">
                  <div className="input-group mt-4">
                    <div
                      className="input-group-text bg-transparent"
                      style={{ borderRadius: "20px", marginRight: "5px", marginLeft: "-5px" }}
                    >
                      <UsernameIcon />
                    </div>
                    <Field
                ...
                <div className="d-grid">
                  <Button
                    ...
                    style={{ marginTop: "1rem", width: "320px", marginBottom: "0.2rem" }}
                    type="submit"
                  >
                    Iniciar Sesion
                  </Button>
          ...
          {/* <div
            ...
            style={{ width: "25rem", marginLeft: "35rem", marginTop: "10rem", borderRadius: "40px" }}
          >
            ...
            <Button
              ...
              style={{ marginTop: "1rem", width: "310px", marginBottom: "0.2rem" }}
              type="submit"
            >
              Enviar
            </Button>
